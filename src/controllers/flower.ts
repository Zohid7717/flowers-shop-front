...
//Create
export const createFlower: RequestHandler = async (req, res) => {
  try {
...
//Get All
export const getFlowers: RequestHandler = async (req, res) => {
  try {
    const flowers = await Flower.find().sort('flower_name')
    if (!flowers) {
...
//Remove 
export const removeFlower: RequestHandler = async (req, res) => {
  try {
